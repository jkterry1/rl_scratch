...
#env = ss.frame_stack_v1(ss.normalize_obs_v0(ss.resize_v0(ss.dtype_v0(ss.color_reduction_v0(env, mode='B'),'float32'), x_size=20, y_size=76)), 3)

env = ss.normalize_obs_v0(ss.resize_v0(ss.dtype_v0(ss.color_reduction_v0(env, mode='B'),'float32'), x_size=20, y_size=76)), 3
