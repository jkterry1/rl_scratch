...
model = PPO2(CnnPolicy, env, gamma=.3, n_steps=2, ent_coef=.07, learning_rate=.0002, vf_coef=.5, max_grad_norm=.25, lam=.9, nminibatches=500, noptepochs=15, cliprange_vf=.15, tensorboard_log=('/home/justinkterry/tensorboard_logs/'))
