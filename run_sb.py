...
checkpoint_callback = CheckpointCallback(save_freq=400, save_path='/home/justinkterry/logs')
model = PPO2(CnnPolicy, env, verbose=1, gamma=.3, n_steps=75, ent_coef=.07, learning_rate=.0002, vf_coef=.5, max_grad_norm=.25, lam=.9, nminibatches=6, noptepochs=15, cliprange_vf=.15, tensorboard_log=('/home/justinkterry/tensorboard_logs/'))
